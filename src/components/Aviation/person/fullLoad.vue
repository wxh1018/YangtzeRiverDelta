...
export default {
  data() {
    return {
      ...
      top10: [],
      totalData: [
        { O: "宁波市", D: "上海市", "满载率(%)": 58.9, "货物（吨）": 1859.866 },
        { O: "宁波市", D: "淮安市", "满载率(%)": 79.6, "货物（吨）": 0.005 },
        { O: "宁波市", D: "盐城市", "满载率(%)": 81.2, "货物（吨）": 0 },
        { O: "宁波市", D: "连云港市", "满载率(%)": 89.8, "货物（吨）": 0 },
        { O: "宁波市", D: "杭州市", "满载率(%)": 0.2, "货物（吨）": 12.749 },
        { O: "宁波市", D: "安庆市", "满载率(%)": 85.6, "货物（吨）": 12.749 },
        { O: "宁波市", D: "池州市", "满载率(%)": 82.2, "货物（吨）": 12.749 },
        // { O: "宁波市", D: "温州市", "满载率(%)": 571, "货物（吨）": 3.485 },
        { O: "宁波市", D: "南京市", "满载率(%)": 6.5, "货物（吨）": 552.753 },
        { O: "宁波市", D: "无锡市", "满载率(%)": 82.8, "货物（吨）": 0 }
      ]
    };
  },
  components: {
  ...
  methods: {
    ech1() {
      ...
      moveLines = this.totalData.map((v, id) => {
        ...
        let value = v["满载率(%)"];
        let width = value > 89 ? 300 / 50 + 1 : value / 50 + 1;
