...
export default {
  ...
  methods: {
    ...
    ech() {
      ...
      this.totalNum = NBData.length;
      var TotalData = NBData.map(v => v[1]);
      ...
      console.log(convertData(TotalData));
      var option = {
        ...
        tooltip: {
          trigger: "item",
          backgroundColor: "rgb(0, 255, 255, 0.7)",
          borderColor: "#FFFFCC",
          showDelay: 0,
          hideDelay: 0,
          enterable: true,
          ...
          formatter: function(params, ticket, callback) {
            ...
            if (params.seriesType == "effectScatter") {
              res =
                `<span style="color:blue">Top 10</span><br>` +
        ...
        visualMap: {
          ...
          left: "left",
          top: "bottom",
          text: ["接收货物吨数"], // 文本，默认为数值文本
          calculable: true,
          inRange: {
            color: ["white", "skyblue", "red"]
          },
          textStyle: {
            color: "#ffffff"
          }
    ...
    down() {
      var domObj = document.querySelector(".zhen");
      html2canvas(domObj, {
