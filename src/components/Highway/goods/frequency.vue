...
export default {
  data() {
    return {
      ...
      top10: [],
      totalData: [
        { O: "宁波市", D: "绍兴市", "总货车数量（PCU/日)": 16371 },
        { O: "宁波市", D: "杭州市", "总货车数量（PCU/日)": 15410 },
        { O: "宁波市", D: "南京市", "总货车数量（PCU/日)": 13165 },
        { O: "宁波市", D: "台州市", "总货车数量（PCU/日)": 10554 },
        { O: "宁波市", D: "金华市", "总货车数量（PCU/日)": 9692 },
        { O: "宁波市", D: "嘉兴市", "总货车数量（PCU/日)": 8536 },
        { O: "宁波市", D: "上海市", "总货车数量（PCU/日)": 7602 },
        { O: "宁波市", D: "温州市", "总货车数量（PCU/日)": 4153 },
        { O: "宁波市", D: "舟山市", "总货车数量（PCU/日)": 3273 },
        { O: "宁波市", D: "湖州市", "总货车数量（PCU/日)": 2622 },
        { O: "宁波市", D: "衢州市", "总货车数量（PCU/日)": 1376 },
        { O: "宁波市", D: "合肥市", "总货车数量（PCU/日)": 825 },
        { O: "宁波市", D: "丽水市", "总货车数量（PCU/日)": 449 }
      ]
    };
  },
  components: {
  ...
  created() {
    ...
    this.$store.commit("setLeftActive", "3-2");
    setTimeout(() => {
  ...
  methods: {
    ech1() {
      ...
      moveLines = this.totalData.map((v, id) => {
        ...
        let value = parseInt(v["总货车数量（PCU/日)"]);
        let lineStyle = {
          width: value / 1000 + 1,
          opacity: 0.9,
          curveness: 0.2
        ...
        tooltip: {
          ...
          formatter: function(params) {
            ...
            if (params.componentSubType == "scatter") {
              ...
              toname = params.data.toname;
              return (
                fromname + "---->" + toname + "<br/>" + "总货车数量（PCU/日):" + value
              );
            }
          }
        },
